...
from model.model import MingMindConfig, MingMindForCausalLM
...
def init_model(args):
    ...
    if 'model' in args.load_from:
        model = MingMindForCausalLM(MingMindConfig(
...
def main():
    parser = argparse.ArgumentParser(description="MingMind模型推理与对话")
